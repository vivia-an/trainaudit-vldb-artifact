...
#
# The scripts under benchmark/ and core/ are the ones that were actually run, so they carry
# the absolute paths of the machines they ran on — three different roots, 157 of 177 path
# references pointing at directories that exist on none of them any more:
#
#   /volume/qscai/lsk        107 refs in 44 files
#   /volume/qscai/cqs         49 refs in 33 files
#   /volume/posttrain/users   20 refs in  8 files
#   /volume/pt-train/users     1 ref  in  1 file
#
# They are shipped unedited on purpose: they are the record of what ran. This makes them
# runnable without destroying that, by rewriting into a copy.
#
