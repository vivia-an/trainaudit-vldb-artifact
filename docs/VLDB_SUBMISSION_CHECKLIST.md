...
| R6 | `\vldbavailabilityurl` | PVLDB template macro; renders the availability footnote | **EMPTY** — `main.tex:16` `\renewcommand\vldbavailabilityurl{}` | set to the public artifact URL |
