...
REPO_ROOT = _find_root("trainaudit")
# _find_root returns the package's PARENT, which is what both an import path and
# `python3 -m trainaudit` need; the old layout nested one more level.
