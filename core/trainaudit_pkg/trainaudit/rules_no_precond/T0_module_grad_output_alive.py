...
def check(conn) -> RuleResult:
    ...
    for event_id, payload_str in rows:
        ...
        # ABLATED[no_precond:T0-module-grad-output-alive]: dropped `_PARAM_MODULES` skip
        # ABLATED[no_precond:T0-module-grad-output-alive]: RECON_S2 §A row "T0-module-grad-output-alive"
