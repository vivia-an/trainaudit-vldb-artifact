#!/bin/bash
#
# 测试 backward前 DP 参数 cksum 一致性约束的错误注入
#
# 用途：通过在 backward 前注入参数 cksum 不一致错误，验证 SDCCheck 约束检测系统能否正确识别
...
# 清理之前的数据
export VTIMELINE_LOGGER_DIR=/volume/qscai/lsk/Megatron-LM/cksum_before_backward_test_db
...
echo ""
echo "关键信息："
echo "  - 约束名称: backward前DP参数cksum一致性检查"
