#!/usr/bin/env python3
"""Extract buggy- and fixed-side Real-SE outcomes from the released smoke logs.

Each log marks both phases with a `===== ... BUGGY|FIXED ... =====` banner and
then a tagged detection or clean verdict. The current confirmed-case scope is
read from `real_se_detection.csv`.
...
def main():
    ...
    # Write atomically because the generated CSV is consumed by other checks.
