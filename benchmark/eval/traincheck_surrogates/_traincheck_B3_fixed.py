...
import os
os.environ['ML_DAIKON_OUTPUT_DIR'] = "/tmp/tc_B3/trace_fixed"
...
proxy_config.__dict__.update({'proxy_log_dir': '/tmp/tc_B3/trace_fixed/proxy_log.json'})
