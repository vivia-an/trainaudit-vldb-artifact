...
import os
os.environ['ML_DAIKON_OUTPUT_DIR'] = "/tmp/tc_OC-NEW-3/trace_fixed"
...
proxy_config.__dict__.update({'proxy_log_dir': '/tmp/tc_OC-NEW-3/trace_fixed/proxy_log.json'})
...
def sqrt_decay(progress, initial_lr=0.001, decay_min_lr=0.0):
