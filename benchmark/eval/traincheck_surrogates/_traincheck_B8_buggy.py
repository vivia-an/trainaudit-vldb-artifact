...
import os
os.environ['ML_DAIKON_OUTPUT_DIR'] = "/tmp/tc_B8/trace_buggy"
...
proxy_config.__dict__.update({'proxy_log_dir': '/tmp/tc_B8/trace_buggy/proxy_log.json'})
...
class MoEBlock(nn.Module):
    ...
    def __init__(self, hidden=8, n_experts=8, declared_ep_size=2):
        ...
        self.declared_ep_size = declared_ep_size
...
def main():
    annotate_stage('init')
    torch.manual_seed(0)
    model = nn.Sequential(nn.Linear(8, 8), MoEBlock(8, n_experts=8, declared_ep_size=2), nn.Linear(8, 4))
