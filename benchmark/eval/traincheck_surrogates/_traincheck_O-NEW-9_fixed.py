...
import os
os.environ['ML_DAIKON_OUTPUT_DIR'] = "/tmp/tc_O-NEW-9/trace_fixed"
...
proxy_config.__dict__.update({'proxy_log_dir': '/tmp/tc_O-NEW-9/trace_fixed/proxy_log.json'})
...
from traincheck.instrumentor.tracer import Instrumentor
Instrumentor(Dataset, scan_proxy_in_args=True, use_full_instr=False, funcs_to_instr=None, API_dump_stack_trace=False).instrument()
