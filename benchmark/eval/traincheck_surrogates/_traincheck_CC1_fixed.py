...
import os
os.environ['ML_DAIKON_OUTPUT_DIR'] = "/tmp/tc_CC1/trace_fixed"
...
proxy_config.__dict__.update({'proxy_log_dir': '/tmp/tc_CC1/trace_fixed/proxy_log.json'})
...
def main():
    ...
    print(f'[CC1_fixed] config.zero_stage={config['zero_stage']}  optimizer.has_partitioned_state={opt.has_partitioned_state}  ⟹ P10 holds')
