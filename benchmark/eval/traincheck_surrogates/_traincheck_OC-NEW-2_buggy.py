...
import os
os.environ['ML_DAIKON_OUTPUT_DIR'] = "/tmp/tc_OC-NEW-2/trace_buggy"
...
proxy_config.__dict__.update({'proxy_log_dir': '/tmp/tc_OC-NEW-2/trace_buggy/proxy_log.json'})
...
def main():
    ...
    opt = FrozenStepAdamW(model.parameters(), lr=0.001)
