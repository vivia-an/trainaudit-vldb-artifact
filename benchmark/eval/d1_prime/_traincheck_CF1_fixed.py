...
import os
os.environ.setdefault('ML_DAIKON_OUTPUT_DIR', "/tmp/tc_CF1/trace_fixed")
...
'CF1 surrogate (fixed): aux-loss tracker guarded by torch.is_grad_enabled().'
import torch
...
class MoELayer(nn.Module):
    ...
    def forward(self, x):
        ...
        # fixed: only accumulate when grad is enabled
