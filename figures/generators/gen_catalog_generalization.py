#!/usr/bin/env python3
"""Catalog-generalization figure (single-column, SIGMOD style).
...
Style matches figures/gen_ablation_v2.py (serif, stix, 7pt, pdf.fonttype 42).
"""
import matplotlib
matplotlib.use('Agg')
...
def catalog_generalization_figure(path):
    ...
    ax.annotate('+19.7 pts\nat equal size', xy=(15, 57.6), xytext=(10.1, 46),
