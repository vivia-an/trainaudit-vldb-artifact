...
icon_brain(23.6, 4.0, 0.9, '#39404d')
txt(25.8, 4.0, 'LLM Agents (offline only):', fs=4.3, w='bold', ha='left')
...
fig.savefig('fig_overview_v10.pdf')
fig.savefig('/tmp/fig_overview_v10.png', dpi=220)
print('done')
