...
for x, name, sub, ec, lw, fc in steps:
    ...
    txt(x + (9.3 if name == 'Construct' else 8.25), 84.6, name, fs=5.6, w='bold', c=ec)
...
ax.plot([80.7, 92.8], [48.2, 48.2], color=BLUE, lw=0.5, zorder=5)
...
fig.savefig('fig_overview_v5.pdf')
fig.savefig('/tmp/fig_overview_v5.png', dpi=220)
print('done')
