#!/usr/bin/env python3
"""v19 = v18 + continuous logic flow + aesthetic polish (no label change).
Labels identical to v18. No Agents / 0-4 / 43k / fake hex.
"""
import matplotlib
matplotlib.use('Agg')
...
# FSM implements pipeline above — thin bridge (closes visual logic gap)
ax.plot([29.5, 102.5], [63.55, 63.55], color=BLUE_SOFT, lw=LW_HAIR, alpha=0.45,
        ls=(0, (1.6, 1.4)), zorder=3)
txt(28.8, 62.05, 'five-stage FSM', fs=3.85, c=GRAY, ha='left')
...
fig.savefig('fig_overview_v19.pdf')
fig.savefig('/tmp/fig_overview_v19.png', dpi=240)
print('done v19')
