#!/usr/bin/env python3
"""v28 = v27 + shorten DuckDB/under-lane arrows (no label change).
Compact gutters (~1.8); tip stays at bay edge — no left overflow.
Labels identical to v27/v22. No Agents / 0-4 / 43k / fake hex.
"""
import matplotlib
matplotlib.use('Agg')
...
fig.savefig('fig_overview_v28.pdf')
fig.savefig('/tmp/fig_overview_v28.png', dpi=240)
print('done v28')
