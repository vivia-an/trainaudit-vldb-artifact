#!/usr/bin/env python3
"""v29 = v28 + Lib→Verifier arrow retarget (no label change).
Tip lands on Verifier top edge — no cross through SQL card.
Labels identical to v28/v22. No Agents / 0-4 / 43k / fake hex.
"""
import matplotlib
matplotlib.use('Agg')
...
fig.savefig('fig_overview_v29.pdf')
fig.savefig('/tmp/fig_overview_v29.png', dpi=240)
print('done v29')
