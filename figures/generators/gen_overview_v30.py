#!/usr/bin/env python3
"""v30 = v29 + Library subtitle clear of P3 dark header (no label change).
'guarded relational constraints' sits on white, not on charcoal band.
Labels identical to v29/v22. No Agents / 0-4 / 43k / fake hex.
"""
import matplotlib
matplotlib.use('Agg')
...
fig.savefig('fig_overview_v30.pdf')
fig.savefig('/tmp/fig_overview_v30.png', dpi=240)
print('done v30')
