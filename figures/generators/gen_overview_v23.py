#!/usr/bin/env python3
"""v23 = v22 + left-bay & OFFLINE/ONLINE band symmetry (no label change).
Labels identical to v22. No Agents / 0-4 / 43k / fake hex.
"""
import matplotlib
matplotlib.use('Agg')
...
BAND_INSET = 0.45
ON_Y, ON_H = 14.6, 35.0            # Collector+Verifier / online output / violation
...
# ================= outer container =================
_outer_y, _outer_h = 6.4, BAND_OFF_Y + BAND_H - 6.4 + 1.6
...
_title_y = BAND_OFF_Y + BAND_H + 1.55
...
arrow((RX, ON_Y + 2.5), (LX + LW, ON_Y + ON_H * 0.45), c=DARK, lw=LW_THICK, ms=11,
      cs='arc3,rad=-0.04', halo=True)
...
fig.savefig('fig_overview_v23.pdf')
fig.savefig('/tmp/fig_overview_v23.png', dpi=240)
print('done v23')
